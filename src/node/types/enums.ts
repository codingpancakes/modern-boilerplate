...
export const getAppointmentStatusValues = (): string[] => Object.values(AppointmentStatus);
export const getSessionStatusValues = (): string[] => Object.values(SessionStatus);
export const getAttendeeStatusValues = (): string[] => Object.values(AttendeeStatus);
