...
const costMonitoringStack = new CostMonitoringStack(
	app,
	`${stackPrefix}-CostMonitoringStack`,
	{
		env,
		stage,
...
const cloudTrailStack = new CloudTrailStack(
	app,
	`${stackPrefix}-CloudTrailStack`,
	{
		env,
		stage,
	},
